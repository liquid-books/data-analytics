...
::::{card} The Data Revolution in Sports
...
:::{figure} images/sports_analytics_dashboard.jpg
:alt: A dashboard showing player tracking data and shot efficiency charts
:width: 80%

Figure 1.1: Modern sports analytics relies on complex dashboards visualizing player efficiency and movement patterns.
:::
...
:::{tip}
**Why Sports Analytics Matters for Learning**
...
For our purposes, we define BI as the comprehensive capability for transforming data into actionable intelligence that improves business decision-making at all organizational levels.
:::
...
:::{dropdown} Click to expand the BI Architecture Layers
...
:::::{tab-set}
::::{tab-item} Transaction Processing (OLTP)
...
::::{tab-item} Analytic Processing (OLAP)
...
:::{important}
Descriptive analytics answers the question "What happened?" by summarizing historical data to identify patterns and trends. It represents the foundation of organizational analytics capabilities.
:::
...
::::{card} APPLICATION CASE 1.2: How Spotify Uses Listening Data to Personalize User Experience and Drive Artist Discovery
...
::::{card} APPLICATION CASE 1.3: How the NBA Uses Predictive Analytics for Player Health and Injury Prevention
...
:::{math}
:label: optimization_example
\text{minimize } Z = \sum_{i=1}^{n} c_i x_i \\
\text{subject to } \sum_{j=1}^{m} a_{ij} x_j \ge b_i, \quad x_j \ge 0
```text
...
::::{card} APPLICATION CASE 1.5: How Johns Hopkins Used Analytics to Track and Predict COVID-19 Spread
...
:::{dropdown} Key Retail Analytics Applications
...
:::{figure} images/5vs_big_data.png
:alt: Diagram illustrating Volume, Velocity, Variety, Veracity, and Value
:width: 80%

Figure 1.2: The 5 V's of Big Data: Volume, Velocity, Variety, Veracity, and Value.
:::
...
::::{card} APPLICATION CASE 1.8: How Walmart Uses Generative AI to Enhance Supply Chain Decision-Making
...
:::{dropdown} Click to expand Chapter Summary
